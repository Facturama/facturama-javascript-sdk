...
var cfdiInicial = {
    ...
    "PaymentForm": "03",         // No es necesario especificar la forma de pago
    "PaymentMethod": "PUE",         // El método de pago es "Por definir"
    "Issuer":{
        "Rfc": "EKU9003173C9",
...
function testPaymentComplement20() {
    ...
    Facturama.Cfdi.Create3(cfdiInicial, function(result){ 
	    ...
	    var type = "issuedLite";            // Las emitidas en Multiemisor son: issuedLite
